...
@first_vendor = Vendor.create(name: 'First Vendor', picture: @vendor_picture, address: "", facebook: @facebook, twitter: @twitter, instagram: @instagram,  story: @lorem, mission: @lorem)
@second_vendor = Vendor.create(name: 'Second Vendor', picture: @vendor_picture, address: "", facebook: @facebook, twitter: @twitter, instagram: @instagram, story: @lorem, mission: @lorem)
@third_vendor = Vendor.create(name: 'Third Vendor', picture: @vendor_picture, address: "", facebook: @facebook, twitter: @twitter, instagram: @instagram, story: @lorem, mission: @lorem)
@fourth_vendor = Vendor.create(name: 'Fourth Vendor', picture: @vendor_picture, address: "", facebook: @facebook, twitter: @twitter, instagram: @instagram, story: @lorem, mission: @lorem)
@fifth_vendor = Vendor.create(name: 'Fifth Vendor', picture: @vendor_picture, address: "", facebook: @facebook, twitter: @twitter, instagram: @instagram, story: @lorem, mission: @lorem)
...
@first_product = Product.create(name: 'First Product', vendor: @first_vendor, picture: @product_picture, vegan: true, gluten_free: false, dairy_free: false, lc_based: false, fair: false, eco_sound: true, humane: true, upc: "", origin: "America", cultural_history: @lorem)
...
@third_product = Product.create(name: 'Third Product', vendor: @first_vendor, picture: @product_picture, vegan: false, gluten_free: true, dairy_free: true, lc_based: false, fair: true, eco_sound: false, humane: false, upc: "", origin: "Mexico", cultural_history: @lorem)
@fourth_product = Product.create(name: 'Fourth Product', vendor: @first_vendor, picture: @product_picture, vegan: false, gluten_free: true, dairy_free: false, lc_based: true, fair: true, eco_sound: false, humane: false, upc: "", origin: "Great Britain", cultural_history: @lorem)
